...
function Left(props) {
	const LockIcon = () => (
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 26" className="h-4 w-4">
			<path
				fill="#ffffff"
	...
	return (
		<div>
			<Link to="/" className="flex flex-row items-center font-normal text-white space-x-1">
				<LockIcon />
				<h2>Urlock</h2>
			</Link>
		</div>
